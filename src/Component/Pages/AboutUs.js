      ...
      <section className="aboitUsSection">
        <div className="content_container position-relative">
          <div className="servicePageBanner">
            ...
            <h4 className="serviceKeyPoints colorBlack fw-800 wow animate__animated animate__fadeInUp animation_delay_300ms">Agility.</h4>
            <h4 className="serviceKeyPoints colorBlack fw-800 wow animate__animated animate__fadeInUp animation_delay_500ms">Strategy.</h4>
            <h4 className="serviceKeyPoints colorRed fw-800 wow animate__animated animate__fadeInUp animation_delay_700ms">Technology.</h4>
            <img
