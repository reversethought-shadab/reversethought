...
const AymSyntexAnnualReport = (props) => {
  useEffect(() => {
      ...
      <section className="ourWork">
        <div className="content_container">
          <h1 className="projectHeading colorBlack fw-800 text-center wow animate__animated animate__fadeIn">
            Aym Syntax Annual Report
          </h1>
          <img
            src="/images/our-work/creative_design/aymannual/AYM1.svg"
            alt="Memoria"
          ...
          <div className="gridSystem">
            ...
            <div className="gridSystemInner">
              <div className="d-flex customGap">
                <img
                  src="/images/our-work/creative_design/aymannual/Aym3.svg"
                  alt="elleys-1"
        ...
        <div className="content_container">
          <div className="row m-0">
            <div className="col-12 p-0 fullWidth wow animate__animated animate__slideInDown">
              <img
                src="/images/our-work/creative_design/aymannual/21.svg"
                alt="service1"
                className="w-100 "
              />
            </div>
            ...
            <div>
              <div className="sliderInner">
                <div className="imgHoverEffect position-relative">
                  ...
                  <img
                    src="/images/our-work/creative_design/aymannual/Maskgroup.svg"
                    alt="work"
                  />
                </div>
...
export default AymSyntexAnnualReport;
