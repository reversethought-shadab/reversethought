    ...
    <>
      <section className="ourWork">
        <div className="content_container">
          ...
          <img
            src="/images/our-work/websites/nagarkot/image267.svg"
            alt="nagarkot"
          ...
          <div className="gridSystem">
            <div className="gridSystemInner">
              ...
              <div className="row m-0 briefDetails wow animate__animated animate__fadeIn">
                <div className="col-sm-6 p-0 briefDetailsInner wow animate__animated animate__fadeInLeft">
                  ...
                  <span className="colorGrey fw-400">nagarkot Logistics</span>
                </div>
                <div className="col-sm-6 p-0 briefDetailsInner wow animate__animated animate__fadeInLeft">
                  <h4 className="colorBlack fw-800">Industry</h4>
                  <span className="colorGrey fw-400">Logisting & Shiping</span>
                </div>
            ...
            <div className="gridSystemInner">
              <div className="d-flex customGap">
                <img
                  src="/images/our-work/websites/nagarkot/m11.svg"
                  alt="nagarkot UI"
                  className="img-fluid w-100 wow animate__animated animate__fadeInRight"
                />
                <img
                  src="/images/our-work/websites/nagarkot/m21.svg"
                  alt="nagarkot UI"
                  className="img-fluid w-100 wow animate__animated animate__fadeInRight"
                />
              </div>
        ...
        <div className="content_container">
          <div className="row m-0">
            <div className="col-12 p-0 fullWidth wow animate__animated animate__slideInDown">
              <img
                src="/images/our-work/websites/nagarkot/283.svg"
                alt="service1"
                className="w-100"
              />
            </div>
            <div className="col-sm-6 p-0 leftImg wow animate__animated animate__slideInLeft">
              <img
                src="/images/our-work/websites/nagarkot/01.svg"
                alt="service2"
            ...
            <div className="col-sm-6 p-0 rightImg wow animate__animated animate__slideInRight">
              <img
                src="/images/our-work/websites/nagarkot/07.svg"
                alt="service3"
                className="w-100"
              />
              <img
                src="/images/our-work/websites/nagarkot/09.svg"
                alt="service4"
                className="w-100"
              />
            </div>
...
export default NagarkotLogistics;
