        ...
        <div className="content_container">
          ...
          {isACtive === 4 ? (
            <div className="projectGalleryMain">
              ...
              <div className="projectsGalleryM">
                <a href="/aym-syntex-annual-report">
                  <div className="project_box wow animate__animated animate__fadeInUp">
                    <img
