...
const ClientLogo = (props) => {
    ...
    const websiteclientArr = [
        'welspun_group','icici_bank','malik','elleys','vardhman','notandas','aym_syntex','goodricke','local_2030','nagarkot','continuum','dodhia'
    ]

    const videoclientArr = [
        'alkem','bfl','idea','pernord_ricard','welspun_group','solus','canadian_wood','hitachi','nem_lab','sutlej_textitle','vardhman','speak_health'
    ]

    const digiMarkertlientArr = [
        'dabur','e_audition','solus','canadian_wood','icici_prudential','speak_health','cutbrand','mpuh','jindal_saw','sky_greens','indulsand_bank','jesons'
    ]

    const creativeDeisgnArr = [
        'icici_bank','tata','aditya_birla_capital','speak','aym_syntex','mpuh'
    ]

    const digitalActivationArr = [
        'marico','amazon','loreal','alkem','mcdowells'
    ]
